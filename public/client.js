$( document ).ready(function() {
  ...
  $('#display').on('click','li.bookItem', function() {
    ...
    $.getJSON('/api/books/'+itemsRaw[this.id]['_id'], function(data) {
      ...
      let after_comments = [];
      after_comments.push('<form id="newCommentForm"><input style="width:300px" type="text" class="form-control" id="commentToAdd" name="comment" placeholder="New Comment"><br>');
      after_comments.push('<button class="btn btn-info addComment" id="'+ data._id +'" data-i="'+ this_id +'">Add Comment</button>');
